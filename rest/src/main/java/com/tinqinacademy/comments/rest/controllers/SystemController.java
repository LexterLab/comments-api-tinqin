...
public class SystemController extends BaseController {
    ...
    public SystemController(EditUserComment editUserComment, DeleteRoom deleteRoom) {
        this.editUserComment = editUserComment;
    ...
    @ApiResponses( value = {
            @ApiResponse(
                    ...
                    schema = @Schema(implementation = EditUserCommentOutput.class))
            ),
    ...
    @ApiResponses( value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "HTTP STATUS 200 SUCCESS", content = @Content(mediaType = "application/json",
                    schema = @Schema(implementation = DeleteRoomCommentOutput.class))
            ),
            @ApiResponse(responseCode = "400", description = "HTTP STATUS 400 BAD REQUEST"),
            @ApiResponse(responseCode = "401", description = "HTTP STATUS 401 UNAUTHORIZED"),
            @ApiResponse(responseCode = "403", description = "HTTP STATUS 403 FORBIDDEN"),
